...
Este capítulo deploys MyCoolProject to Cloud Run for the first time. This is done manually from your local machine. After this, GitHub Actions takes over for all subsequent deploys.
...
- **07 — First Deploy** (capítulo actual)
